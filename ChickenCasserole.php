  ...
  <body>
    ...
    <header id="home">
      ...
      <div class="main-content flex-jcse">
        <div class="main-content-part-1">
          <div class="h2-div">
            <h2 class="capital">Broccoli Chicken Casserole</h2>
          </div>
        ...
        <div class="main-content-part-2 flex">
          <img src="images/main-bg-and-img/casserole.png" alt="content" />
        </div>
      </div>
    </header>
    ...
    <p class="main-content-p">
      ...
      <br><br>
        ...
        Nutrition:
        <br>
Calories: 620cal | Carbohydrates: 20g | Protein: 3g | Fat: 20g | Saturated Fat: 10g | Cholesterol: 358mg | Sodium: 226mg | Potassium: 121mg | Sugar: 1g | Vitamin A: 830IU | Calcium: 49mg | Iron: 2mg
<br><br>        
</p>
